...
export default class ViewAdmin extends React.Component {
    ...
    componentDidMount  () {
        axios.get("http://localhost:8088/register/view/ad")
    ...
    onSubmit = async () => {
        ...
        try {
		 await axios.put(`http://localhost:8088/register/edit/${this.state.userID}`, admin)
        .then((res)=> this.setState({
            message: err.message,
            type:"error",
            open: true
            ...
            <>
                ...
                <div className="AllView">
                    ...
                    <Box sx={{
                        ...
                        <h1 style={{color: 'white', marginTop: '-25px'}}>View Administrators</h1>
