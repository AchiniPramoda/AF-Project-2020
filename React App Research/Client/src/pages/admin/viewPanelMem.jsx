...
export default class ViewPanelMembers extends React.Component {
    ...
    onSubmit = async () => {
        ...
        try {
		 await axios.put(`http://localhost:8088/register/edit/${this.state.userID}`, panelmembers)
        .then((res)=> this.setState({
            message: err.message,
            type:"error",
            open: true
            ...
            <>
                ...
                <div className="AllView">
                    ...
                    <Box sx={{
                        ...
                        <h1 style={{color: 'white', marginTop: '-25px'}}>View Students</h1>
